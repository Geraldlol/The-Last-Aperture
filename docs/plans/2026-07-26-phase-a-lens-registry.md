...
| File | Responsibility |
|---|---|
| `skills/red-team-audit/lenses/_schema.md` | Candidate-finding contract |
| `skills/red-team-audit/lenses/_harness.md` | Shared proof-harness pieces lenses reference by name |
| `skills/red-team-audit/lenses/_topics.md` | **Generated.** Canonical slug registry |
| `skills/red-team-audit/lenses/<10 domain>.md` | One domain each |
| `skills/red-team-audit/lenses/ai-generated-code.md` | Always-on machine-authored-code tells |
| `skills/red-team-audit/lenses/{attack-chaining,business-logic,completeness}.md` | Triage lenses (frontmatter + skeleton only in Phase A; bodies in Phase B) |
...
**Files:**
- Create: `skills/red-team-audit/lenses/<14 files>.md`, `docs/migration-ledger.tsv`
...
```bash
git add skills/red-team-audit/lenses/<lens>.md docs/migration-ledger.tsv
...
**Files:**
- Create: `skills/red-team-audit/lenses/_harness.md`, `skills/red-team-audit/lenses/_schema.md`
...
```bash
grep -oh '_harness\.md[^)]*→ *`[^`]*`' skills/red-team-audit/lenses/*.md | sort -u
```
...
```bash
git add skills/red-team-audit/lenses/_harness.md skills/red-team-audit/lenses/_schema.md
